...
<main role="main" class="app__content">
    ...
    <ul class="breadcrumbs">
        <li class="breadcrumbs__item">
            <a href="#" class="breadcrumbs__link">Заказы</a>
        </li>
    </ul>
    <!--/. Breadcrumbs End -->
    ...
    <div class="app__header">
        <div class="app__header-left">
            <h1 class="app__header-title">Заказы</h1>
        </div>
    ...
    <div class="default-card">
        <div class="search">
            <input type="text" class="search__input" placeholder="Поиск по заказам">
        </div>
        <div class="default-table">
            <table>
                ...
                <tbody>
                    <tr>
                        <td data-title="№">158244627730</td>
                        <td data-title="Имя">Алибек</td>
                        <td data-title="Телефон">+7 701 758 48 92</td>
                        <td data-title="Тип доставки">Самовывоз</td>
                        <td data-title="Дата">Сегодня, в 7:19</td>
                        <td data-title="Статус"><span class="bg-green default-table__status">Доставлен</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td data-title="Тип доставки">Самовывоз</td>
                        <td data-title="Дата">Сегодня, в 7:19</td>
                        <td data-title="Статус"><span class="bg-red default-table__status">Отменен</span>
                        </td>
                        <td data-title="Действия">
                            <div class="default-table__actions">
                                <a href="#" class="default-table__button">
                    ...
                    <tr>
                        ...
                        <td data-title="Тип доставки">Самовывоз</td>
                        <td data-title="Дата">Сегодня, в 7:19</td>
                        <td data-title="Статус"><span class="bg-yellow default-table__status">В ожидании</span>
                        </td>
                        <td data-title="Действия">
                            <div class="default-table__actions">
                                <a href="#" class="default-table__button">
