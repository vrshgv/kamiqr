...
<main role="main" class="app__content">
    ...
    <ul class="breadcrumbs">
        <li class="breadcrumbs__item">
            <a href="#" class="breadcrumbs__link">Каталоги</a>
        </li>
    </ul>
    <!--/. Breadcrumbs End -->
    ...
    <div class="app__header">
        <div class="app__header-left">
            <h1 class="app__header-title">Каталоги</h1>
        </div>
        <div class="results-text d-lg-none">Записи с 1 до 2</div>
        <router-link to='/new-catalog' class="button -blue app__header-button">
    ...
    <div class="default-card">
        <div class="search">
            <input type="text" class="search__input" placeholder="Поиск по категориям">
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-title="Обложка">
                            <a href="#">
                                <img src="static/img/content/p1.jpg" class="default-table__img -square" alt="">
                            </a>
                        </td>
                        <td data-title="Найменование"><a href="#">https://kamiqr.com/pl/129872197712</a>
                        </td>
                        <td data-title="Меню">Основное меню</td>
                        <td data-title="Описание">Соған ұқсаған іштегі жан қуатыменен жиған нəрсенің аты ақыл, ғылым еді ғой.</td>
