...
<main role="main" class="app__content">
    ...
    <ul class="breadcrumbs">
        <li class="breadcrumbs__item">
            <a href="#" class="breadcrumbs__link">Закуски</a>
        </li>
    </ul>
    <!--/. Breadcrumbs End -->
    ...
    <div class="app__header">
        <div class="app__header-left">
            <h1 class="app__header-title">Закуски</h1>
        </div>
    ...
    <div class="default-card">
        <div class="search">
            <input type="text" class="search__input" placeholder="Поиск по продуктам">
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-title="Категория">Основное меню</td>
